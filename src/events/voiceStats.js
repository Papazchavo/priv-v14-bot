const joinedAt = require("../../settings/schemas/voiceJoinedAt");
const joinedAt2 = require("../../settings/schemas/streamerJoinedAt");
const joinedAt3 = require("../../settings/schemas/cameraJoinedAt");
const streamerUser = require("../../settings/schemas/streamerUser");
const cameraUser = require("../../settings/schemas/cameraUser");
const voiceUser = require("../../settings/schemas/voiceUser");
const voiceGuild = require("../../settings/schemas/voiceGuild");
const guildChannel = require("../../settings/schemas/voiceGuildChannel");
const userChannel = require("../../settings/schemas/voiceUserChannel");
const streamerUserChannel = require("../../settings/schemas/streamerUserChannel");
const cameraUserChannel = require("../../settings/schemas/cameraUserChannel");
const userParent = require("../../settings/schemas/voiceUserParent");
