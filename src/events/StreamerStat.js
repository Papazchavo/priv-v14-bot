...
const JoinedAt2 = require("../../settings/schemas/JoinedAt2")
...
await StreamerStat.findOneAndUpdate({ guildID: System.GuildID, userID: user.id },{ $inc: { TotalStat: data, DailyStat: data, WeeklyStat: data, MonthlyStat: data } },  { upsert: true });
await StreamerUserChannel.findOneAndUpdate({ guildID: System.GuildID, userID: user.id, ChannelID: channel.id}, { $inc: { ChannelData: data } }, { upsert: true });
}
}
module.exports.conf = {
