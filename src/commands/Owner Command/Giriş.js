...
const settings = require('../../../settings/configs/sunucuayar.json');
...
client.on('interactionCreate', async (interaction) => {
  if (interaction.customId === 'kabul') {
    const modal = new ModalBuilder()
      ...
      const papaz = new TextInputBuilder()
          .setCustomId('isim')
          ...
          const AOne = new ActionRowBuilder().addComponents(papaz);
    ...
    const modal = new ModalBuilder()
      ...
      const papaz = new TextInputBuilder()
          ...
          const AOnee = new ActionRowBuilder().addComponents(papaz);
