...
const kanallar = require("../../../settings/schemas/channelData");
...
module.exports = {
  ...
  run: async (client, message, args, embed, prefix) => {
        if (!message.member.permissions.has(PermissionsBitField.Flags.Administrator) && !papazcim.owners.some(x => message.member.roles.cache.has(x))) {
